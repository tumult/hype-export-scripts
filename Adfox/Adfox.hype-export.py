...
# 	Adfox.hype-export.py
#		Export Script for Tumult Hype to produce HTML5 ads for Yandex Adfox
#			https://yandex.ru/support/adfox-sites/banners/specs/banner-html5.html?lang=en
#
#		Installation, usage, and additional info: 
#			https://tumult.com/hype/export-scripts/
#
#		MIT License
#		Copyright (c) 2023 Tumult Inc.
#
...
version_info_url = "https://static.tumult.com/hype/export-scripts/Adfox/latest_script_version.txt" # only returns a version number
download_url = "https://tumult.com/hype/export-scripts/Adfox/" # gives a user info to download and install
minimum_update_check_duration_in_seconds = 60 * 60 * 24 # once a day
defaults_bundle_identifier = "com.tumult.Hype2.hype-export.Adfox"
...
insert_at_head_end = """
	...
	function hypeAdEvent(eventNumber) {
		callEvent(parseInt(eventNumber));
	}
	...
	if args.get_options:		
		...
		def extra_actions():
			return [
				...
				{"label" : "Ad Event", "function" : "hypeAdEvent", "arguments":[{"label":"Event Number", "type": "String"}]},
			]
