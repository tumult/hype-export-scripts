...
# 	Emerse.hype-export.py
#		Export Script for Tumult Hype to produce HTML5 ads for Emerse
#
...
version_info_url = "https://static.tumult.com/hype/export-scripts/Emerse/latest_script_version.txt" # only returns a version number
download_url = "https://tumult.com/hype/export-scripts/Emerse/" # gives a user info to download and install
minimum_update_check_duration_in_seconds = 60 * 60 * 24 # once a day
defaults_bundle_identifier = "com.tumult.Hype2.hype-export.Emerse"
...
<a href="${clickTag}" onClick="EmerseClick(event, '${clickTag}')">
"""
insert_at_body_end = """
</a>
"""
...
def main():
	...
	##				arguments: array of strings
		...
		# add in clickTag, width/height into insert_at_head_start and insert_at_body_start variables
		global insert_at_head_start
		global insert_at_body_start
		head_start_template = string.Template(insert_at_head_start)
		body_start_template = string.Template(insert_at_body_start)
		...
		insert_at_head_start = head_start_template.substitute({'width' : export_info['main_container_width'], 'height' : export_info['main_container_height'] })
		insert_at_body_start = body_start_template.substitute({"clickTag" : click_tag })
