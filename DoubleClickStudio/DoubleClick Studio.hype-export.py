...
version_info_url = "https://static.tumult.com/hype/export-scripts/DoubleClickStudio/latest_script_version.txt" # only returns a version number
download_url = "https://tumult.com/hype/export-scripts/DoubleClickStudio/" # gives a user info to download and install
minimum_update_check_duration_in_seconds = 60 * 60 * 24 # once a day
defaults_bundle_identifier = "com.tumult.Hype2.hype-export.DoubleClickStudio"
...
def main():
	...
	if args.get_options:		
		...
		def extra_actions():
			return [
				{"label" : "Exit", "function" : "hypeAdExit", "arguments":[{"label":"id", "type": "String"}]},
				{"label" : "Exit Override", "function" : "hypeAdExit", "arguments":[{"label":"id", "type": "String"}, {"label":"url", "type": "String"}]},
				{"label" : "Counter", "function" : "hypeAdCounter", "arguments":[{"label":"eventId", "type": "String"}]},
				{"label" : "Start Timer", "function" : "hypeAdStartTimer", "arguments":[{"label":"timerId", "type": "String"}]},
				{"label" : "Stop Timer", "function" : "hypeAdStopTimer", "arguments":[{"label":"timerId", "type": "String"}]},				
			]
