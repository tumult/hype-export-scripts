...
# 	Yahoo.hype-export.py
#		Export Script for Tumult Hype to produce HTML5 ads for Yahoo DSP
#			https://adspecs.yahooinc.com/pages/policies-guidelines/html5-guidelines
#
...
version_info_url = "https://static.tumult.com/hype/export-scripts/Yahoo/latest_script_version.txt" # only returns a version number
download_url = "https://tumult.com/hype/export-scripts/Yahoo/" # gives a user info to download and install
minimum_update_check_duration_in_seconds = 60 * 60 * 24 # once a day
defaults_bundle_identifier = "com.tumult.Hype2.hype-export.Yahoo"
