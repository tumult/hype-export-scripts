...
# 	AppNexus.hype-export.py
#		Export Script for Tumult Hype to produce HTML5 ads for Xandr AppNexus Standard Ads
#		See documentation:
#			https://github.com/appnexus/appnexus-html5-lib/blob/master/docs/Walkthrough-For-Manually-Created-Ads.md#standard-ads
#
...
defaults_bundle_identifier = "com.tumult.Hype2.hype-export.AppNexus"
